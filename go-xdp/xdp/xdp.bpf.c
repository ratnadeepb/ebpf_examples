...
// // Similar to bpftrace -e 'tracepoint:raw_syscalls:sys_enter { @[comm] =
// // count();}'
// BPF_PERF_OUTPUT (events)
// SEC ("raw_tracepoint/sys_enter")
// int
// hello_bpftrace (void *ctx)
// {
//   char data[100];
...
//   __uint (max_entries, XCONNECT_MAP_SIZE);
//   __type (key, __u32);
//   __type (value, __u32);
// } xconnect_map SEC (".maps");

// SEC ("xdp")
// int
// xdp_xconnect (struct xdp_md *ctx)
// {
...
parse_ip_src_addr (struct xdp_md *ctx, __u32 *ip_src_addr)
{
...
SEC ("xdp")
int
xdp_prog_func (struct xdp_md *ctx)
{
  __u32 ip;
